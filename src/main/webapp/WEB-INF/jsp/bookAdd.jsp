<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="models.Book" import="models.Shelf" import="models.Author"%>
...
<body class="bg-dark">
    ...
    <header class="navbar navbar-dark bg-success rounded">
        <a class="navbar-brand" href="<%=request.getContextPath()%>"><h1 class="application-name display-3">Library</h1></a>
        <span>
            <a class="btn btn-dark btn-lg m-1" href="Acceuil.html"><i class="fas fa-sign-out-alt mr-1"></i>Logout</a>
			<a class="btn btn-dark btn-lg m-1" href="<%=request.getContextPath()%>"><i class="fas fa-user mr-1"></i>Accueil</a>
			<a class="btn btn-dark btn-lg m-1" href="signature.html"><i class="fas fa-user mr-1"></i>User</a>
        </span>
    </header>

	<h2 class="text-center display-3">Add book</h2>

    <div class="rox col-12 container-fluid">

       	<form class="col-4 offset-1" action="bookAdd" method="post">
			...
			<p class="form-group">
			<label for="authorLastName">Author last name</label> <input type="text"
				class="form-control" name="authorLastName" id="authorLastName" value="" requiered>
		</p>
		
			<p class="form-group">
			<label for="authorFirstName">Author first name</label> <input type="text"
				class="form-control" name="authorFirstName" id="authorFirstName" value="" requiered>
		</p>
		
			<p class="form-group">
			<label for="shelfRef">Shelf reference</label> <input type="text"
				class="form-control" name="shelfRef" id="shelfRef" value="" requiered>
		</p>
		
		<p class="form-group">
			<label for="shelfSection">Section</label> <input type="text"
				class="form-control" name="shelfSection" id="shelfSection" value="" requiered>
		</p>
